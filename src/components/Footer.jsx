            ...
            <div className="mx-auto w-full max-w-screen-xl">
                <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
                    <div>
                        ...
                        <ul className="text-navText dark:text-gray-400 font-medium">
                            <li className="mb-4">
                ...
                <div className="px-4 py-6 dark:bg-gray-700 md:flex md:items-center md:justify-between">
                    <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© {new Date().getFullYear()} <a href="https://flowbite.com/">NovaPro™</a>. All Rights Reserved.
                    </span>
